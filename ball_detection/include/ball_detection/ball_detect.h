...
cv::Mat buffer_color(480,640,CV_8UC3);
cv::Mat buffer_depth(480,640,CV_16UC1);
...
void remove_trashval(std::vector<Point2f> &center, std::vector<float> &radius, int pixel_radius);
